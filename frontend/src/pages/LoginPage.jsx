        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-yellow-50">
                <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md text-center">
                    <h2 className="text-2xl font-semibold mb-6 text-gray-800">You are already logged in.</h2>
                    <button
                    ...
                    <button
                        className="mt-4 ml-4 px-4 py-2 bg-gray-200 text-yellow-800 rounded hover:bg-yellow-100 transition"
